<?php 
	...
	$nav_produk_footer		= $this->KonfigurasiModel->nav_produk();
			...
			<div class="row">
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						...
						<li class="p-b-10"><a href="<?php echo base_url('produk/kategori/'.$nav_produk_footer->slug_kategori) ?>" class="stext-107 cl7 hov-cl1 trans-04">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<ul>
						<li class="p-b-10">
							<a href="<?php echo base_url('pesanan_khusus') ?>" class="stext-107 cl7 hov-cl1 trans-04">
								Buat Pesanan Khusus
							</a>
						</li>
					</ul>
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<div class="p-t-27">
						...
						<a href="<?php echo $site->whatsapp ?>" class="fs-18 cl7 hov-cl1 trans-04 m-r-16">
		...
		<div class="container">
			<div class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent">
				<button class="how-pos3 hov3 trans-04 js-hide-modal1">
					<img src="<?php echo base_url() ?>assets/template2/images/icons/icon-close.png" alt="CLOSE">
				</button>
						...
						<div class="p-l-25 p-r-30 p-lr-0-lg">
							<div class="wrap-slick3 flex-sb flex-w">
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/image/'.$nav_produk_footer->gambar) ?>">
										<div class="wrap-pic-w pos-relative">
											<img src="<?php echo base_url('assets/upload/image/'.$nav_produk_footer->gambar) ?>" alt="IMG-PRODUCT">

											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="<?php echo base_url('assets/upload/image/'.$nav_produk_footer->gambar) ?>">
					...
					<div class="col-md-6 col-lg-5 p-b-30">
						...
						<div class="p-r-50 p-t-5 p-lr-0-lg">
							<h4 class="mtext-105 cl2 js-name-detail p-b-14">
								<?php echo $nav_produk_footer->nama_produk ?>
							</h4>

							<span class="mtext-106 cl2">
								Rp. <?php echo number_format($nav_produk_footer->harga, '0', ',', '.' ) ?>
							</span>
...
<!--===============================================================================================-->
	...
	<script>
        ...
        function initialize() {
        var propertiPeta = {
            center:new google.maps.LatLng(-6.846069,106.887521),
            zoom:15,
