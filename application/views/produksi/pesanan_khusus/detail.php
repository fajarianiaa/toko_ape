...
<div class="container-fluid">
    ...
    <p class="pull-right">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url('produksi/pesanan_khusus') ?>" title="Kembali" class="btn btn-info btn-sm m-1">
                    <i class="fa fa-backward"></i> Kembali
                </a>
                <?php if($pesanan_khusus->status_pengiriman == "Diterima" || $pesanan_khusus->status_pengiriman == "Sedang Dikirim"){
                    echo '<a href="#" class="btn btn-success btn-sm m-1 disabled"> <i class="fa fa-check"></i> Konfirmasi Produksi </a>';
                }else{ ?>
                    <a href="<?php echo base_url('produksi/pesanan_khusus/konfirm/'.$pesanan_khusus->id_pesanan)  ?>" title="Konfirmasi Produksi" class="btn btn-success btn-sm m-1">
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-info">Detail <?php echo $title ?></h6>
    </div>
    <div class="card-body">
