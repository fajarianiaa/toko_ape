...
<div class="container-fluid">
    ...
    <p class="pull-right">
            <div class="btn-group pull-right">
                <a href="<?php echo base_url('pengiriman/pesanan_khusus') ?>" title="Kembali" class="btn btn-info btn-sm m-1">
                ...
                <?php if($pesanan_khusus->status_produksi == "Sedang Diproduksi" || $pesanan_khusus->status_produksi == "Belum Diproduksi" || $pesanan_khusus->status_pengiriman == "Diterima"){
                    ...
                    <a href="<?php echo base_url('pengiriman/pesanan_khusus/konfirm/'.$pesanan_khusus->id_pesanan)  ?>" title="Konfirmasi Produksi" class="btn btn-success btn-sm m-1">
