...
<div class="container-fluid">
    <!-- <button class="btn btn-sm btn-primary mb-3" data-toggle="modal" data-target="#tambah_user"><i class="fas fa-plus fa-sm"></i> Tambah <?php echo $title ?> </button> -->
            ...
            <tbody>
                ...
                foreach($user as $user) :  ?>
                    <tr>
                        ...
                        <td>Bagian <?php echo $user->role_id ?></td>
                        <td>
                          <a href="<?php echo base_url('penjualan/user/edit/'.$user->id_user) ?>" class="btn btn-primary btn-sm"><i class="fas fa-edit"></i> Edit</a>
                          <a href="<?php echo base_url('penjualan/user/hapus/'.$user->id_user) ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus data ini?')"><i class="fas fa-trash"></i> Hapus</a>
                        </td>
                    </tr>
                	<?php endforeach;?>
            </tbody>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<?php echo base_url().'penjualan/user/tambah' ?>" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label>Nama Pegawais</label>
