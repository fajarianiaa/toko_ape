...
//Form
echo form_open_multipart(base_url('penjualan/produk/edit/'.$produk->id_produk), ' class="form-horizontal"');
?>
...
<div class="card-body container-fluid w3-margin">
    <div class="form-group form-gruop-lg">
        ...
        <div class="col-md-5">
            <input type="text" name="nama_produk" class="form-control" value="<?php echo $produk->nama_produk ?>" placeholder="Masukkan Nama Produk" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Kode Produk</label>
        <div class="col-md-5">
            <input type="text" name="kode_produk" class="form-control" value="<?php echo $produk->kode_produk ?>" placeholder="Masukkan Kode Produk" required>
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-md-5">
            <input type="number" name="harga" class="form-control" value="<?php echo $produk->harga ?>" placeholder="Masukkan Harga Produk" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Stok Produk</label>
        <div class="col-md-5">
            <input type="number" name="stok" class="form-control" value="<?php echo $produk->stok ?>" placeholder="Masukkan Stok Produk" required>
        </div>
    </div>
    <!-- <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Berat Produk</label>
        <div class="col-md-5">
            <input type="text" name="berat" class="form-control" value="<?php echo $produk->berat ?>" placeholder="Masukkan Berat Produk" required>
        </div>
    </div>
    <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Ukuran Produk</label>
        <div class="col-md-5">
            <input type="text" name="ukuran" class="form-control" value="<?php echo $produk->ukuran ?>" placeholder="Masukkan Ukuran Produk" required>
        </div>
    </div> -->
    <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Keterangan</label>
        <div class="col-md-10">
            <textarea name="keterangan" class="form-control" placeholder="Masukkan Keterangan Produk" id="editor" cols="30" rows="5"> <?php echo $produk->keterangan ?></textarea>
        </div>
    </div>
    <!-- <div class="form-group">
        <label class="col-md-5 control-label text-dark font-weight-bold">Keyword (untuk SEO Google)</label>
        <div class="col-md-10">
            <textarea name="keywords" class="form-control" placeholder="Masukkan Keyword (untuk  SEO Google)" ><?php echo $produk->keywords ?></textarea>
        </div>
    </div> -->
    <div class="form-group">
