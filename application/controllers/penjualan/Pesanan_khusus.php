...
class Pesanan_khusus extends CI_Controller {
    ...
    public function detail($id_pesanan){
		...
		$data = array( 	'title'				=> 'Pesanan Khusus',
						'pesanan_khusus'    => $pesanan_khusus,
						'isi'				=> 'admin/pesanan_khusus/detail'
		);
		$this->load->view('templates_admin/wrapper', $data, FALSE);
    }
    ...
    public function konfirm($id_pesanan){
        ...
        if ($valid->run()===FALSE) {
            $data = array( 	
                ...
                'pesanan_khusus' 	=> $pesanan_khusus,
                'isi'				=> 'admin/pesanan_khusus/konfirm'
            );
            $this->load->view('templates_admin/wrapper', $data, FALSE);
        }else{
            $i    = $this->input;
            ...
            redirect(base_url('admin/pesanan_khusus'), 'refresh');
        }
    }
